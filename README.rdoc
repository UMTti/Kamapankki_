<h1>Kamapankki - a place where users can create "common households"</h1>
...
<ul>Knows that producing new items consume natural resources often without a real purpose</ul>
<ul>Don't want to buy everything by himself, because students haven't much money</ul>
<ul>Have many close communities and friends and wants to try exciting things with them</ul>
